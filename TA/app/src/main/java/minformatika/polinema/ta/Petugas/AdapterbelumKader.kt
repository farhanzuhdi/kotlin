...
class AdapterbelumKader (val dataKader : List<HashMap<String,String>>) :
    RecyclerView.Adapter<AdapterbelumKader.HolderDataKader>() {

    private lateinit var mListener:OnItemClickListener

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): AdapterbelumKader.HolderDataKader {
    ...
    override fun onBindViewHolder(p0: AdapterbelumKader.HolderDataKader, p1: Int) {
